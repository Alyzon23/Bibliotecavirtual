...
class FuturisticCategoryAccordion extends StatelessWidget {
  final Map<String, List<String>> categories;
  final bool showCategoryAccordion;
  final VoidCallback onToggle;
  final Function(String) onCategorySelected;

  const FuturisticCategoryAccordion({
    super.key,
    required this.categories,
    required this.showCategoryAccordion,
